...
const es: LocaleResource = {
  ...
  data: {
    ...
    importBody:
      'Desde una carpeta de archivos Markdown (también Obsidian), una copia de Bear (.bear2bk), una exportación de Notion (.zip) o de FixNote. Todo se queda en este dispositivo.',
    chooseFiles: 'Elegir archivos',
    chooseFolder: 'Elegir carpeta',
    reading: 'Leyendo archivos…',
    source: {
      fixnote: 'Exportación de FixNote',
    ...
    nothingFound: 'No hay notas en estos archivos.',
    start: 'Importar',
    importing: 'Importando {{done}} de {{total}}…',
    imported: 'Notas importadas: {{count}}',
  ...
  share: {
    ...
    body: 'Cualquiera con el enlace puede leer una copia de esta nota. La clave va en el enlace, así que el servidor de FixNote no puede leerla.',
    signIn: 'Los enlaces se guardan en el servidor, así que compartir necesita una cuenta.',
    signInButton: 'Entrar',
    create: 'Crear enlace',
    working: 'Un momento…',
    copy: 'Copiar',
    ...
    snapshot:
      'El enlace muestra la nota tal como estaba el {{time}}. Los cambios posteriores aparecen al actualizarlo.',
    outdated: 'La nota ha cambiado desde entonces.',
    update: 'Actualizar',
    ...
    page: {
      shared: 'Compartida {{date}}',
      gone: 'Este enlace ya no funciona',
      goneBody: 'Su dueño lo desactivó, o nunca existió.',
      broken: 'Este enlace está incompleto',
      brokenBody: 'Falta o cambió la parte después de #. Pide el enlace de nuevo.',
      omitted: 'Algunas imágenes no se incluyen: {{count}}.',
      footer:
        'Compartida desde FixNote. Cifrada de extremo a extremo: solo quien tenga este enlace puede leerla.',
      failed: 'No se pudo cargar la nota. Revisa tu conexión y vuelve a intentarlo.',
    },
  },
  sync: {
